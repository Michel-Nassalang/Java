...
public class Divertissement extends Emission{
	...
	public void affichage() { // fonction d'affichage  
		System.out.println("-------------------------");
		System.out.println("On a pour cette émission : le " + type() + " \"" + this.getNom() + "\" qui dure " + this.getDuree() + " h, commence à " + this.getHdiffuse() + " h et est animé par " + this.getAnimateur() + "." );
	}
