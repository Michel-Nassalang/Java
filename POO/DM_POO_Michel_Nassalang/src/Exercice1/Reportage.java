...
public class Reportage extends Emission{
		...
		if((h>=14 && h<=18) || (h>=0 && h<=6)) {
			...
			do {
				...
				try {
					...
					System.out.print("Veuillez donner une valeur correcte et comprise entre 0-6 heures ou 18-23 heures: ");
					error = true;
				}
	...
	public void affichage() { // fonction d'affichage 
		System.out.println("-------------------------");
		System.out.println("On a pour cette émission : le " + type() + " \"" + this.getNom() + "\" qui dure " + this.getDuree() + " h, commence à " + this.getHdiffuse() + " h et traite le thème " + this.getTheme() + "." );
	}
}
