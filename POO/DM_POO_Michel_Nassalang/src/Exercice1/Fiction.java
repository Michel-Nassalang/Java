...
public class Fiction extends Emission{
	...
	public void affichage() { // fonction d'affichage 
		System.out.println("-------------------------");
		System.out.println("On a pour cette émission : la " + type() + " \"" + this.getNom() + "\" " + this.rediffusion() +" qui dure " + this.getDuree() + " h, commence à " + this.getHdiffuse() + " h et est réalisé par " + this.getRealis() + " à l'an "+ this.getAnnee() +"." );
	}
