...
public class Gestion_stock {
	...
	static int menu() {
		 int entree = 0;
			...
			while((entree!=1) && (entree!=2) && (entree!=3) && (entree!=4) && (entree!=5) && (entree!=6) && (entree!=7) && (entree!=8)) {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1 : 
				...
				System.out.println(produit.getNom() + " qui est référencé par " + produit.getReference() + " avec une quantité de " + produit.getQuantite() + " coûte " + produit.getPrix() + " Fcfa");
				break;
			case 2 : 
			...
			case 5 : 
				...
				System.out.println(produitNom.getNom() + " qui est référencé par " + produitNom.getReference() + " avec une quantité de " + produitNom.getQuantite() + " coûte " + produitNom.getPrix() + " Fcfa");
				break;
			case 6 :
				System.out.println("Recherche d'un article par intervalle de prix de vente");
				System.out.println("Donnez l'intervalle de prix où on recherche en donnant le minimum suivi du maximum: ");
